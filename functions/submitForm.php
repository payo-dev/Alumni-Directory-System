...
// --------------------------------------
// 3️⃣ Insert or Update into alumni table
// --------------------------------------
$columns = array_keys($fieldsMap);
$placeholders = array_map(fn($c) => ":$c", $columns);

$sql = "INSERT INTO alumni (" . implode(',', $columns) . ", `status`, `issued_date`)
        VALUES (" . implode(',', $placeholders) . ", 'pending', NOW())
...
$tmpDir = __DIR__ . '/../assets/alumni_2x2/tmp';
if (is_dir($tmpDir)) {
