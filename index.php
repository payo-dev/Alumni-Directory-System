...
// ==========================================================
session_start(); // ✅ enables form persistence across steps
...
// ✅ Save posted form data into session before changing sections
...
if ($current_section) {
  ...
  switch ($current_section) {
    ...
    default: $file_to_include = $base_path . 'alumniInfo.php'; $current_step = 1; break;
  }
}
  ...
  <div class="mainContainer">
    <header class="header-content">
      ...
      <div class="right-header-block">
        <?php if ($current_section): ?>
          <a href="index.php" class="back-link-img" onclick="return confirm('<?php echo htmlspecialchars($confirm_message, ENT_QUOTES); ?>');">
    ...
    <?php if ($current_section): ?>
      ...
      <nav class="section-nav">
        ...
        foreach ($section_keys as $key => $section_name): 
          ...
          $onclick_handler = ($key < $current_index) ? 'onclick="return confirm(\'' . htmlspecialchars($confirm_message, ENT_QUOTES) . '\');"' : '';
        ?>
